window.onload = function() {
    ...
    function selectWords() {
      ...
      for (var i = 0; i < 10; i++) {
        ...
        word.textContent = chineseWords[selectedIndices[i]]; // 顯示中文解釋
    ...
    function showTranslation() {
      ...
      for (var i = 0; i < wordWrappers.length; i++) {
        ...
        var index = chineseWords.indexOf(word.textContent); // 改為中文單字的索引
  
        if (index >= 0) {
          translation.textContent = englishWords[index]; // 顯示英文單字
        }
      }
    }
